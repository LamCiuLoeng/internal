...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="64" valign="top" align="left"><a href="/access/add?type=sample_profile"><img src="/images/images/menu_new_g.jpg"/></a></td>
...
<div class="nav-tree">Access&nbsp;&nbsp;&gt;&nbsp;&nbsp;Sample Profile Management</div>

<div>
	${widget(action="/access/sample_profile",value=values)|n}
</div>
...
%if result:
	...
	<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:800px">
      ...
      %endif
			<tr>
				<th width="300">Profile Name</th>
				<th width="300">Teammate Group</th>
				<th width="300">Manager Group</th>
		...
		<tbody>
			%for u in result:
			<tr>
				<td><a href="/access/sample_profile_manage?id=${u.id}">${u.name}</a>&nbsp;</td>
				<td>${str(u.group or '')}&nbsp;</td>
				<td>${str(u.manager_group or '')}&nbsp;</td>
				<td>${str(u.region or '')}&nbsp;</td>
				<td>${str(u.team or '')}&nbsp;</td>
			</tr>
			%endfor
			%if my_page.item_count > 0 :
