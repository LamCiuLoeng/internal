...
<div style="margin: 10px 0px; overflow: hidden;">
  <div style="float: left;">
    ...
    %elif type=="prepress_profile":
    <div>
      <form name="prepressProfileForm" class="tableform" method="post" action="/access/save_new">
        <input type="hidden" name="type" value="prepress_profile"/>
        <div class="case-list-one">
          <div class="case-list">
            <ul>
              <li class="label">
                <label for="name" class="fieldlabel">Prepress Profile Name</label>
              </li>
              <li>
                <input type="text" id="name" name="name" class="textfield" style="width: 250px;"/>
              </li>
        ...
        <div class="case-list-one">
          <div class="case-list">
            <input type="submit" name="submit" value="Save Profile" class="submitbutton" id="prepress_profile_submit"/>
            <input type="reset" name="reset" value="Reset" class="resetbutton" id="prepress_profile_reset"/>
          </div>
        </div>
        <div style="clear: both;"><br/>
        </div>
