...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="64" valign="top" align="left"><a href="/access/add?type=prepress_profile"><img src="/images/images/menu_new_g.jpg"/></a></td>
...
<div class="nav-tree">Access&nbsp;&nbsp;&gt;&nbsp;&nbsp;Prepress Profile Management</div>

<div>
	${widget(action="/access/prepress_profile",value=values)|n}
</div>
	...
	<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:800px">
      ...
      %endif
		...
		<tbody>
			%for u in result:
			<tr>
				<td><a href="/access/prepress_profile_manage?id=${u.id}">${u.name}</a>&nbsp;</td>
