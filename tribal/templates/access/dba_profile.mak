...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="64" valign="top" align="left"><a href="/access/add?type=dba_profile"><img src="/images/images/menu_new_g.jpg"/></a></td>
...
<div class="nav-tree">Access&nbsp;&nbsp;&gt;&nbsp;&nbsp;DBA Profile Management</div>

<div>
	${widget(action="/access/dba_profile",value=values)|n}
</div>
	...
	<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:800px">
      ...
      %endif
			<tr>
				...
				<th width="300">Related Group</th>
				<th width="400">Related Customer</th>
			</tr>
		</thead>
		<tbody>
			%for u in result:
			<tr>
				<td><a href="/access/dba_profile_manage?id=${u.id}">${u.name}</a>&nbsp;</td>
				<td>${str(u.group or '')}&nbsp;</td>
				<td>${str(u.customer or '')}&nbsp;</td>
			</tr>
			%endfor
			%if my_page.item_count > 0 :
      <tr>
