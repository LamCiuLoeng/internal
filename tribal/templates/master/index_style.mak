...
<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:900px">
    <thead>
        ...
        <tr>
            ...
            <th width="300">Main Part</th>
            <th width="300">Extra Part</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td>${u.lang}&nbsp;</td>
            <td><a href="/${funcURL}/update?id=${u.id}" class="${'required link-text' if u.active==1 else 'link-text'}">${u.mainPart}</a>&nbsp;</td>
            <td>${u.extraPart}&nbsp;
            </td>
        </tr>
			%endfor
