...
<table class="gridTable" cellpadding="0" cellspacing="0" border="0" style="width:900px">
    <thead>
        ...
        <tr>
            ...
            <th width="450">Item Description</th>
            <th width="150">Brand</th>
            <th width="150">Item Class</th>
        </tr>
    </thead>
    <tbody>
        ...
        <tr>
            ...
            <td><a href="/${funcURL}/update?id=${u.id}" class="${'required link-text' if u.active==1 else 'link-text'}">${u.itemCode}</a>&nbsp;</td>
            <td>${u.itemDesc}&nbsp;</td>
            <td>${u.brand}&nbsp;</td>
            <td>${u.itemClass}&nbsp;</td>
        </tr>
