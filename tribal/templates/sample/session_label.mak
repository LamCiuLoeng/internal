...
$(document).ready(function(){
	$("#SFLabel-output_other").click(function(){
		workCheckBox($(this),
			[
			"#SFLabel-output_other_content"
			]
		)		
	})
})
...
<div class="div1">
        ...
        <table class="table2" cellspacing="0" cellpadding="0" border="0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input ${_r('Others','color')}/>Other&nbsp;<input ${_i('color_other')} class="input-150px" />
                </td>
            </tr>
        </table>
    </fieldset>
    <fieldset>
        ...
        <table class="table2">
            <tr>
                <td width="30"><input ${_c('btw','output')}/></td>
                <td>BTW (Bartender)</td>
            </tr>
            <tr>
