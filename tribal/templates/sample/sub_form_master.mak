...
<%include file="${dbObject.getWidget().sub_template}" args="prefix=prefix,disable=disable,_=_,_d=_d,_f=_f,_i=_i,_c=_c,_cid=_cid,_r=_r,_incd=_incd"/>
    ...
    <fieldset>
        ...
        <table class="table2" cellspacing="0" cellpadding="0" border="0">
            %if dbObject and not inspect.isclass(dbObject) and dbObject.getAttachment():
	            <tr>
	        		<td colspan="3"><a href='/sample/downloadAllAttachment?form_id=${dbObject.__class__.__name__}&sub_id=${dbObject.id}' target="_blank">Download All</a></td>
	        	</tr>
