...
<script>
    ...
    var cancelJob = function(po){
        if(confirm("Are you sure to cancel this order? \n " + po)){
            $("#save_form").attr("action", '/dba/cancelOrder').submit();
        }
    }
...
<div id="function-menu">
  ...
  <tbody><tr>
    ...
    <td width="64" valign="top" align="left"><a href="/dba/viewOrder?code=${rpacEncrypt(order.id)}"><img src="/images/images/menu_return_g.jpg"/></a></td>
    <td width="23" valign="top" align="left"><img height="21" width="23" src="/images/images/menu_last.jpg"/></td>
    <td valign="top" style="background:url(/images/images/menu_end.jpg) repeat-x;width:100%"></td>
  </tr>
</tbody></table>
</div>
<div class="nav-tree">DIM&nbsp;&nbsp;&gt;&nbsp;&nbsp;Order Revise</div>
...
<div class="box2">
    ...
    <div>
        <form id="save_form" action="/dba/save_updateOrder" method="post">
            ...
            <tbody class="s_text">
               ...
               %>
                <tr>
                    ...
                    <td class="head">
                        <input type="text" name="add_qty" value="${qty2}" autocomplete="off" readonly="readonly" class="readonly" id="actual_qty_${i.id}" />
                    </td>
...
<div class="clear"></div>
<div class="box2">
    <form id="search_form" action="/dba/updateOrder" method="post">
