...
<%def name="extTitle()">r-pac - DBA</%def>
...
<div id="function-menu">
  ...
  <tbody><tr>
  	<td width="36" valign="top" align="left"><img src="/images/images/menu_start.jpg"/></td>
        <!--
  	<td width="64" valign="top" align="left"><a href="/dba/search"><img src="/images/images/menu_trb_g.jpg"/></a></td>
        -->
...
<div class="nav-tree">DIM&nbsp;&nbsp;&gt;&nbsp;&nbsp;Order Search</div>
...
<div id="recordsArea" style="margin:5px 0px 10px 20px">
	<table class="gridTable" cellpadding="0" cellspacing="0" border="0">
		<%
			label_attrs = [('Customer PO#',"200"), ('Customer Name',"280"), ('Created By',"100"), 
		...
		<tbody>
			...
			%endif
				<td>
				<a href="/dba/viewOrder?code=${rpacEncrypt(order.id)}">${order.po}</a>&nbsp;
				</td>
