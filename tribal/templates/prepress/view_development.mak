...
<div id="function-menu">
  ...
  <tbody><tr>
  	...
  	<td width="64" valign="top" align="left"><a href="/prepress/viewRequest?id=${main.id}"><img src="/images/images/menu_return_g.jpg"/></a></td>
...
<div class="nav-tree">Main&nbsp;&nbsp;&gt;&nbsp;&nbsp;Prepress&nbsp;&nbsp;&gt;&nbsp;&nbsp;Development Log</div>
      ...
      <table cellspacing="0" cellpadding="0" border="0" id="dataTable" class="gridTable">
		<thead>
			<tr>
	    		...
	    		<th width="130">Time ${show_direction('update_time')}</th>
...
<%def name="show_direction(f)">
	%if field == f:
		%if direction == 'desc':
			<a href="/prepress/viewDevelopmentLog?id=${main.id}&f=${f}&d=asc"><img src="/images/down.png"/></a>
		%else:
			<a href="/prepress/viewDevelopmentLog?id=${main.id}&f=${f}&d=desc"><img src="/images/up.png"/></a>
		%endif
	%else:
		<a href="/prepress/viewDevelopmentLog?id=${main.id}&f=${f}&d=desc"><img src="/images/updown.gif"/></a>
	%endif
</%def>